...
trigger23 = stateno = 205 && movecontact
...
trigger28 = stateno = 470 && time = [5,30]
ignorehitpause = 1
var(39) = var(39) | 1
...
ctrl = 0
;triggerall = var(9) != 1
triggerall = command = "shiki2kx"
triggerall = power >= 2000
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = movecontact && stateno = 1802
trigger4 = movecontact && (stateno = 1605 || stateno = 1655)
trigger5 = movecontact && (stateno = 2001 || stateno = 2010)
trigger6 = movecontact && (stateno = 2105 || stateno = 2110)
trigger7 = (stateno = 1700 || stateno = 1710) && projhit1701 = 1, <15
trigger8 = stateno = 1806 && time = [30,65]
trigger9 = (p2stateno = [5000,5999]) && (stateno = 3505 || stateno = 3506 || stateno = 3507) 
trigger10 = movecontact && stateno = 4905
trigger11 = movecontact && stateno = 3010
...
ctrl = 0
;triggerall = var(9) != 1
triggerall = command = "mushiki" && power >= 1000
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = movecontact && stateno = 1802
trigger4 = movecontact && (stateno = 1605 || stateno = 1655)
...
triggerall = var(21) != 1 && power >= 1000 && statetype != A
trigger1 = stateno = 150 
trigger2 = stateno = 152 
...
;triggerall = var(9) != 1
triggerall = command = "knockdown"
triggerall = var(21) = 1 && var(10) > 0 && statetype != A
trigger1 = stateno = 150 
trigger2 = stateno = 152 
...
trigger1 = var(21) = 0 || var(21) = 4 || var(21) = 5
trigger1 = (ctrl || stateno = 100)
...
;triggerall = var(9) != 1
triggerall = command = "shingo"
triggerall = var(43) = 3 && var(31) = 1 && var(34) > 0
trigger1 = roundstate = 2 && numhelper(4000) <= 0
trigger1 = (stateno != [3000,3690]) && (stateno != [4600,4800]) && (stateno != [300,315]) && (stateno != [4900,4999]) && (stateno != [9020,9150])
trigger1 = stateno != 3900 && stateno != 707 && stateno != 4850 && movetype != H && stateno != 0
ignorehitpause = 1
...
triggerall = (var(41) = [0,2]) || var(41) = 4 || var(41) = 5 || var(41) = 6 || var(41) = 7
trigger1 = statetype = A && ctrl
...
triggerall = (var(41) = [0,2]) || var(41) = 5 || (var(41) = [6,7])
trigger1 = statetype != A && ctrl
...
triggerall = var(9) != 1
triggerall = command = "y"
triggerall = (var(41) = [0,4]) || var(41) = 5 || (var(41) = [6,7])
triggerall = p2bodydist x > 30
...
triggerall = var(9) != 1
triggerall = command = "b"
triggerall = (var(41) = [0,1]) || var(41) = 3 || var(41) = 5 || var(41) = 6
trigger1 = statetype = S && ctrl
trigger2 = stateno = 400 && animelemtime(3) >= 3
trigger2 = command != "holddown"
trigger3 = stateno = 420 && animelemtime(3) = [1,2]
...
triggerall = random <= 500 && statetype != A && ctrl
...
value = 255
triggerall = var(9) = 1
triggerall = var(41) = 4 && (p2bodydist x = [0,30]) && (random <= 500)
...
trigger1 = p2statetype != L && statetype = S && ctrl && random <= 500
...
trigger1 = statetype != A && random <= 500 && (p2bodydist x = [0,30]) && stateno = 250 && movehit && animelemtime(2) > 0 && animelemtime(3) < 0
...
value = 2100
triggerall = var(9) = 1
triggerall = movehit && var(41) != 1 && var(41) != 3 && random <= 600
trigger1 = stateno = 250 && animelemtime(2) > 0 && animelemtime(3) < 0
trigger2 = stateno = 270 && animelemtime(3) > 0 && animelemtime(4) < 0
trigger3 = stateno = 440 && animelemtime(3) > 0 && animelemtime(4) < 0
...
triggerall = (P2bodydist X = [0,40]) && p2statetype = L && p2stateno = 5110
...
value = 1170
triggerall = var(9) = 1
triggerall = (var(41) = [1,3]) && random <= 500
...
trigger2 = random <= 500 && p2movetype != A && frontedgebodydist <= 50

[State -1,RUN]
type = ChangeState
value = 100
triggerall = var(9) = 1
trigger1 = (stateno != [100,101]) && statetype = S && ctrl && var(21) != 1
