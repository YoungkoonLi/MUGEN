...
triggerall = (var(21) = 4 &&  power >= 3000) || (var(21) = 5 && power >= 2000)
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && var(21) = 5 && power >= 3000
...
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && var(21) = 5 && power >= 2000
...
triggerall = var(41) != 4 
triggerall = (power >= 3000 && Var(21) = 4) || (var(21) = 5 && power >= 2000)
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && var(21) = 5 && power >= 3000
...
;triggerall = var(9) != 1
triggerall = command = "orochinagi1"
triggerall = (var(21) = 3 && life > 200 && power >= 1000 ) ||(var(21) = 4 && power >= 1000) || (var(21) = 5 && power >= 1000)
triggerall = var(41) != 4
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && var(21) = 5 && power >= 2000
...
triggerall = command = "mushiki"
triggerall = var(41) = 0 || var(41) = 2 || var(41) = 4
triggerall = (var(21) = 4 && power >= 1000) || (var(21) = 5 && power >= 1000)
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && var(21) = 5 && power >= 2000
...
value = 1700
;triggerall = var(9) != 1
triggerall = (command = "fire1" && var(41) = 2) || (command = "apoy1" && var(41) = 1) || (command = "apoy1" && var(41) = 3) 
triggerall = numprojid(1701) = 0
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
...
value = 1710
;triggerall = var(9) != 1
triggerall = (command = "fire2" && var(41) = 2) || (command = "apoy2" && var(41) = 1) || (command = "apoy2" && var(41) = 3) 
triggerall = numprojid(1701) = 0
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
...
value = 1150
;triggerall = var(9) != 1
triggerall = (command = "tres1" && var(41) = 2) || (command = "red1" && var(41) = 1) || (command = "tres1" && var(41) = 3)
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
...
value = 1170
;triggerall = var(9) != 1
triggerall = (command = "tres2" && var(41) = 2) || (command = "red2" && var(41) = 1) || (command = "tres2" && var(41) = 3)
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
...
;triggerall = var(9) != 1
triggerall = command = "fwd_a"
triggerall = (var(41) = [0,1]) || var(41) = 4
trigger1 = statetype = S && ctrl
trigger2 = stateno = 100
...
;triggerall = var(9) != 1
triggerall = command = "fwd_a"
triggerall = var(41) = 2 || var(41) = 5 || (var(41) = [6,7])
trigger1 = statetype = S && ctrl
trigger2 = stateno = 100
...
trigger1 = statetype != A && random <= 900 && (p2bodydist x = [0,30]) && stateno = 250 && movehit && animelemtime(2) > 0 && animelemtime(3) < 0
...
trigger1 = random <= 1000 && statetype != A && ctrl
