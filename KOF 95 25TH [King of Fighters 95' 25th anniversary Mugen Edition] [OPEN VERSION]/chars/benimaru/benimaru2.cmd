...
trigger2 = Var(46) = 0 && (stateno = 1302 || stateno = 1304)
trigger3 = Var(46) = 0 && (stateno = 1352 || stateno = 1354)
trigger4 = Var(46) = 1 && (AnimElem = 9, >= 1 && AnimElem = 10, < 0) && (stateno = 1402 || stateno = 1452)
var(31) = 1
ignorehitpause = 1
...
[State -1]
type = Varset
triggerall = var(30) != 1 && var(33) != 2 && var(10) != 0
...
[State -1]
type = Varset
triggerall = var(30) != 1 && var(33) != 1 && var(10) != 0
triggerall = MoveContact = 1
trigger1 = stateno = 21700
var(33) = 2
ignorehitpause = 1
...
triggerall = command = "escape" && command != "holddown"
...
trigger1 = command = "escape" && command != "holddown"
var(21) = 700
[State -1]
type = varset
trigger1 = command = "escape" && command != "holddown"
...
type = ChangeState
value = 245
triggerall = command = "knockdown";(command = "x" && command = "y")
...
triggerall = (command != "ファイナルフォースミス")
...
type = varset
triggerall = var(20) = 0
trigger1 = P2Dist X >= 0 && command = "ファイナルフォース"
trigger1 = (command != "ファイナルフォースミス")
trigger2 = P2Dist X < 0 && command = "逆ファイナルフォース"
var(20) = 7
[State -1]
type = varset
trigger1 = P2Dist X >= 0 && command = "ファイナルフォース"
...
[State -1]
type = varset
triggerall = var(20) = 7 && power >= 3000
...
triggerall = moveContact = 1
triggerall = power >= 2000 && Var(20) = 7
...
triggerall = moveContact = 1
triggerall = power >= 2000 && Var(20) = 3000
trigger1 = stateno = [1300,1304]
trigger2 = stateno = [1350,1358]
trigger3 = stateno = 1260 || stateno = 1270
trigger4 = stateno = 1402
...
triggerall = (command != "雷光拳_axミス")
triggerall = statetype != A && winko = 0
trigger1 = var(30) = 1 && power >= ifelse(var(47) != 0,1000,2000)
trigger2 = var(31) = 1 && power >= ifelse(var(47) != 0,2000,3000)
trigger3 = ctrl || (stateno = 100 && time >= 3)
...
triggerall = statetype != A && winko = 0
trigger1 = var(30) = 1 && power >= ifelse(var(47) != 0,0,1000)
trigger2 = var(31) = 1 && power >= ifelse(var(47) != 0,1000,2000)
trigger3 = ctrl || (stateno = 100 && time >= 3)
...
triggerall = power >= ifelse(var(47) != 0,1000,2000) && Var(20) = 3
trigger1 = stateno = [1300,1304]
trigger2 = stateno = [1350,1358]
trigger3 = stateno = 1260 || stateno = 1270
...
triggerall = (command != "エレクトリッガー_axミス")
triggerall = statetype != A && winko = 0
trigger1 = var(30) = 1 && power >= ifelse(var(47) != 0,1000,2000)
trigger2 = var(31) = 1 && power >= ifelse(var(47) != 0,2000,3000)
trigger3 = ctrl || (stateno = 100 && time >= 3)
...
triggerall = statetype != A && winko = 0
triggerall = Var(46) = 0
trigger1 = var(30) = 1 && power >= ifelse(var(10) = 0,1000,0)
trigger2 = var(31) = 1 && power >= ifelse(var(10) = 0,2000,1000)
trigger3 = ctrl || (stateno = 100 && time >= 3)
...
type = ChangeState
value = 640
trigger1 = command = "knockdown" ;(command = "hold_x" && command = "hold_y")
