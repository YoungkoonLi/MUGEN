...
value = ifelse(random>=500,1500,1510)
...
[State -1, especial attack anti projectile air]
type = ChangeState
triggerall = (roundstate = 2) && (var(59) != 0)
...
trigger1 = p2bodydist x = [75,150]   
trigger1 = p2statetype = S
trigger1 = Enemy, HitDefAttr = S, SP
trigger1 = random = [0,299]
trigger1 = ctrl                            
value = 1400

[State -1, especial attack anti projectile]
type = ChangeState
triggerall = (roundstate = 2) && (var(59) != 0)
triggerall = Statetype = S
triggerall = p2statetype != L                                     
...
[State -1, especial attack close distance]
type = ChangeState
triggerall = (roundstate = 2) && (var(59) != 0)
triggerall = Statetype = S                            
triggerall = p2statetype != L                                     
...
[State -1, attack super mid distance]
type = ChangeState
triggerall = (roundstate = 2) && (var(59) != 0)
triggerall = Statetype = S && power >= 1000
triggerall = p2statetype != L
...
trigger1 = random = [0,299]
trigger1 = ctrl
trigger2 = StateNo = 3051 && enemy,stateno = [3082,3083]
trigger2 = random = [0,299]
trigger3 = StateNo = 3210 && time >= 86
trigger3 = random = [0,299]
...
[State -1, attack ultra mid distance]
type = ChangeState
triggerall = (roundstate = 2) && (var(59) != 0)
triggerall = Statetype = S && power >= 1000
triggerall = p2statetype != L
...
trigger1 = Power >= 2000 && var(30)=0 && var(47)=0 && life <= 300
...
trigger3 =  StateNo = 3210 && Power >= 2000
triggerall = StateType != A && (Ctrl || (var(40)=[1,3])) 
;---------------------------------------------------------------------
; 鳳凰脚 (MAX版)
[State -1]
...
value = 3250
triggerall = command = "Hou Ou Kyaku (MAX)"
trigger1 = Power >= 2000 && stateno = 3210  
triggerall = StateType != A && Ctrl = 0
;---------------------------------------------------------------------
; 鳳凰脚 (ノーマル版)
[State -1]
type = ChangeState
...
value = 3050
triggerall = command = "Shin! Chouzetsu Tatsumaki Shinkuu Zan"
trigger1 = Power >= 1000 && (stateno = 1500 || stateno = 1510)
triggerall = StateType != A && Ctrl = 0
;---------------------------------------------------------------------
; 真！超絶竜巻真空斬
[State -1]
type = ChangeState
value = 3000
triggerall = command = "Shin! Chouzetsu Tatsumaki Shinkuu Zan(MAX)"
trigger1 = Power >= 2000 && var(30)=0 && var(47)=0
trigger2 = (Power >= 2000 || fvar(0) > 0) && (var(30)=[1,2])
triggerall = !StateType = A && (Ctrl || (var(40)=[1,3]))
...
value = 3000
triggerall = command = "Shin! Chouzetsu Tatsumaki Shinkuu Zan(MAX)"
triggerall = StateType != A && Ctrl = 0 && Power >= 2000
trigger1 = movecontact && (stateno = 1500 || stateno = 1510)
trigger2 = StateNo = 3210
trigger3 = StateNo = 3051 && enemy,stateno = [3082,3083]
;---------------------------------------------------------------------
; 斬！猿月輪
[State -1]
type = ChangeState
