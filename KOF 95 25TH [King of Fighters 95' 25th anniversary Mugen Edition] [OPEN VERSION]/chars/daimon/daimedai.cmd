...
trigger3 = stateno = 2005 && time = [35,66]
trigger4 = stateno = 2105 && time = [26,53]
trigger5 = stateno = 2215 && time = [1,14]
trigger6 = stateno = 2310 && time = [41,60]
trigger7 = stateno = 2410 && time = [44,60]
trigger8 = stateno = 2520 && time = [52,70]
ignorehitpause = 1
var(42) = var(42) | 1
...
[State -1, C.Combo3]
type = Varset
trigger1 = stateno = 2615 && time = [40,138]
ignorehitpause = 1
var(45) = 1
;==============================================================================
;------|HYPER MOVES|-----
...
;triggerall = var(9) != 1
triggerall = command = "earth"
trigger1 = var(40) > 0 && var(42) = 1
trigger2 = var(42) = 1 && power >= 1000
...
value = 4800
;triggerall = var(9) != 1
triggerall = command = "armor" && life <= 300
